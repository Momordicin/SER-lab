...
# Filename parsing: emotion after speaker code
...
# Split flat folder -> train/val/test 
def split_dataset(
    source_dir: str,
    target_dir: str,
...
def main():
    ...
    p_te.add_argument("--preds_csv", default="./w2v2_preds.csv", help="Where to write test-set predictions as CSV with columns y_true,y_pred.")
    p_te.add_argument("--report_txt", default=None,help="Optional path to write a full sklearn classification_report text file.")
